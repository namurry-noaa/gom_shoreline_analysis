...
**Prepared for:** SMS / ADCIRC hydrodynamic modeling team (VDatum tidal datum grids)
**Status:** Release Candidate 1 (RC1) — for modeler review
**Date:** 2026-08-17
**Processing platform:** PostgreSQL 17 / PostGIS 3.6 (Linux), GDAL/OGR
...
| Working color | Dataset / tile (NGS unless noted) | Features | Native CRS |
|---|---|---|---|
| Purple | la2206_cm_c_utm15_merge_shrln_class | 163,010 | NAD83(2011) |
| Green  | la2206_cm_c_utm16_merge_shrln_class | 41,889  | NAD83(2011) |
| Orange | la2205_cm_c_merge_shrln_class       | 20,720  | NAD83 |
| Red    | la2207_cm_c_merge_shrln_class       | 787     | NAD83(2011) |
| (n/a)  | MS_TX_New_Shoreline (Notre Dame)    | 37,557  | NAD83 |
...
## 3. Source Detail Assessment (why the NGS tiles, and why detail matters)
...
![Fig 1. Shoreline detail comparison](figures/fig1_detail_comparison.png)

---

## 4. Method Evolution (what we tried, and why we changed)
...
### 4.1 Attempt 1 — Concave-hull clipping (abandoned)
...
the model, the concave-hull method cannot meet the requirement regardless of tuning.### 4.2 Attempt 2 — Buffer-difference overlap removal (adopted)
...
![Fig 4. Buffer-difference overlap removal at a seam](figures/fig4_seam_before_after.png)

### 4.3 Fragment cleanup (buffer-difference debris)
...
![Fig 2. Clip-debris fragment histogram](figures/fig2_fragment_histogram.png)

### 4.4 Detail-based authority (the key refinement)
...
![Fig 3. Marsh tangle resolved by detail-based authority](figures/fig3_marsh_tangle.png)

![Fig 6. Detail-based authority map](figures/fig6_authority_map.png)

### 4.5 Polygon derivation and feature-size filtering

The reconciled line network is noded and polygonized (`ST_Node` → `ST_Polygonize`)
...
![Fig 5. Polygon product size distribution](figures/fig5_polygon_distribution.png)
...
## 7. Optional Polish & Contingencies (if SMS objects)
...
## 8. What We Did NOT Do (data integrity statement)
